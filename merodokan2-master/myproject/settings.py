...
SECRET_KEY = 'v8oj6kdmmo$(9ec8e30*--%-z-mfqk+12j%m=@h-4ftq6(j2@h'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'products.context_processor.cities',
                'products.context_processor.areas',
...
EMAIL_HOST_USER = 'saagarsharma99@gmail.com'
