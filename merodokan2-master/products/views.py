...
def favourites(self, request, *args, **kwargs):
    ...
    return render(request, 'ads/product_favourite_list.html')
...
def product_favourite_list(request):
    ...
    return render(request, 'ads/product_favourite_list.html', context)
...
def product_detail(request, product_id):
    ...
    return render(request, 'ads/product_detail.html', context)